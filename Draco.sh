...
./apache-jmeter-5.6.3/bin/jmeter -n -t Test8.jmx -l no8-1.csv -e -o testFolder1_8
./apache-jmeter-5.6.3/bin/jmeter -n -t Test8.jmx -l no8-2.csv -e -o testFolder2_8
./apache-jmeter-5.6.3/bin/jmeter -n -t Test8.jmx -l no8-3.csv -e -o testFolder3_8
